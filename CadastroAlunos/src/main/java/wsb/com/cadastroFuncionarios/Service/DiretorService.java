...
public class DiretorService {
	...
	public Optional<Diretor> CadastrarUsuario(Diretor usuario) {
	...
	public Optional<DiretorLogin> Logar(Optional<DiretorLogin> user) {

		BCryptPasswordEncoder encoder = new BCryptPasswordEncoder();
		Optional<Diretor> usuario = repository.findByUsuario(user.get().getUsuario());
